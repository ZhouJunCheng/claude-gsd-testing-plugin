...
// GSD Testing Patch Hook — SessionStart hook (Compatibility Wrapper)
//
// This file is kept for backward compatibility with older installations.
// It redirects to the actual implementation in gsd1/gsd-testing-patch.js

const path = require('path');
const { spawn } = require('child_process');

// Redirect to the actual implementation
const actualScript = path.join(__dirname, 'gsd1', 'gsd-testing-patch.js');
